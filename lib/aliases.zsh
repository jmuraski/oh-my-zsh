...
alias ssh-ca-dev1='ssh -v -i ~/.ssh/ca-ssh-keypair.pem ec2-user@ec2-54-245-110-30.us-west-2.compute.amazonaws.com'
alias ssh-ca-dev2='ssh -v -i ~/.ssh/ca-ssh-keypair.pem ec2-user@ec2-54-245-110-32.us-west-2.compute.amazonaws.com'
alias ssh-jenkins='ssh -v -i ~/.ssh/jenkins-ssh-keypair.pem ec2-user@54.245.238.194'
